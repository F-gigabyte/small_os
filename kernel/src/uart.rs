...
impl UART {
    ...
    pub fn reset(&mut self) {
        ...
        field!(self.registers, int_baud).write((26 << int_baud_rate_register::BAUD_DIVINT_SHIFT) & int_baud_rate_register::BAUD_DIVINT_MASK);
        field!(self.registers, frac_baud).write((3 << frac_baud_rate_register::BAUD_DIVFRAC_SHIFT) & frac_baud_rate_register::BAUD_DIVFRAC_MASK);
